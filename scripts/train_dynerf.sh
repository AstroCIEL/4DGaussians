export CUDA_VISIBLE_DEVICES=1&&python train.py -s data/dynerf/flame_salmon_1 --port 6468 --expname "dynerf/flame_salmon_1" --configs arguments/dynerf/flame_salmon_1.py &
export CUDA_VISIBLE_DEVICES=3&&python train.py -s data/dynerf/coffee_martini --port 6472 --expname "dynerf/coffee_martini" --configs arguments/dynerf/coffee_martini.py  &
wait
...
wait 
export CUDA_VISIBLE_DEVICES=1&&python train.py -s data/dynerf/flame_steak      --port 6471 --expname "dynerf/flame_steak" --configs arguments/dynerf/flame_steak.py &
export CUDA_VISIBLE_DEVICES=2&&python train.py -s data/dynerf/sear_steak       --port 6569 --expname "dynerf/sear_steak" --configs arguments/dynerf/sear_steak.py  
wait
