export CUDA_VISIBLE_DEVICES=1&&python train.py -s data/hypernerf/interp/aleks-teapot --port 6568 --expname "hypernerf/interp/aleks-teapot" --configs arguments/hypernerf/default.py &
export CUDA_VISIBLE_DEVICES=1&&python train.py -s data/hypernerf/interp/slice-banana --port 6566 --expname "hypernerf/interp/slice-banana" --configs arguments/hypernerf/default.py &
export CUDA_VISIBLE_DEVICES=1&&python train.py -s data/hypernerf/interp/chickchicken --port 6569 --expname "hypernerf/interp/interp-chicken" --configs arguments/hypernerf/default.py & 
...
export CUDA_VISIBLE_DEVICES=1&&python train.py -s data/hypernerf/interp/torchocolate --port 6672 --expname hypernerf/interp/torchocolate --configs arguments/hypernerf/default.py &
wait
...
export CUDA_VISIBLE_DEVICES=1&&python render.py --model_path output/hypernerf/interp/slice-banana  --configs arguments/hypernerf/default.py --skip_train &
...
export CUDA_VISIBLE_DEVICES=1&&python render.py --model_path output/hypernerf/interp/hand1-dense-v2  --configs arguments/hypernerf/default.py --skip_train&
...
export CUDA_VISIBLE_DEVICES=1&&python metrics.py --model_path "output/hypernerf/interp/slice-banana/" &
...
export CUDA_VISIBLE_DEVICES=1&&python metrics.py --model_path "output/hypernerf/interp/hand1-dense-v2/" &
