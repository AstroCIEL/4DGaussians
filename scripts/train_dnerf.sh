...
export CUDA_VISIBLE_DEVICES=3&&python train.py -s data/dnerf/hook --port 6266 --expname "$exp_name1/hook" --configs arguments/$exp_name1/hook.py &
wait
...
wait
export CUDA_VISIBLE_DEVICES=2&&python train.py -s data/dnerf/bouncingballs --port 6069 --expname "$exp_name1/bouncingballs" --configs arguments/$exp_name1/bouncingballs.py  &
